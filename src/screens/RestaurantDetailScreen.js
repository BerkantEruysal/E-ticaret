...
const RestaurantDetailScreen = () => {
  ...
  const [data, error, isLoading] = useRequestSender(getContentDetail, {
    targetName: "restaurantDetailList",
    id: slug,
    targetUrl: "/Restaurant/Details?sename=",
  });
  let cachedDataList = useSelector((state) => {
    return state.content.restaurantDetailList;
  });
    ...
    <div>
      {!cachedData ? (
        ...
        <div className="detail-screen-container pb-2">
          <ScreenBreadcrumb
            List={[{ pageName: "food-beverage", text: "Food & Beverage" }]}
